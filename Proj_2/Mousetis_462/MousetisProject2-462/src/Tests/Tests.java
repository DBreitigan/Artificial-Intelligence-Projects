...
public class Tests {
	...
	@Test
	public void TestUtilityHorizontalGood()
	{
		GameBoard g = new GameBoard(4);
		g.board[0][0] = 'B';
		g.board[0][1] = 'B';
		g.board[0][2] = 'R';
		assertEquals(6, g.Evaluate());
	}
	
	@Test
	public void TestUtilityHorizontalBad()
	{
		GameBoard g = new GameBoard(4);
		g.board[0][0] = 'B';
		g.board[0][1] = 'R';
	...
	@Test
	public void TestUtilityVertGood()
	{
		GameBoard g = new GameBoard(4);
		g.board[0][0] = 'B';
		g.board[1][0] = 'B';
	...
	@Test
	public void TestUtilityVertBad()
	{
		GameBoard g = new GameBoard(4);
		g.board[0][0] = 'B';
		g.board[1][0] = 'R';
	...
	@Test
	public void TestUtilityDiagGood()
	{
		GameBoard g = new GameBoard(4);
		g.board[0][0] = 'B';
		g.board[1][0] = 'R';
		...
		g.board[2][1] = 'R';
		g.board[2][2] = 'B';
		assertEquals(12, g.Evaluate());
	}
	
	@Test
	public void TestUtilityDiagBad()
	{
		GameBoard g = new GameBoard(4);
		g.board[0][0] = 'R';
		g.board[1][0] = 'B';
...
*/
	...
	public void TestStateSelection2Column()
	{
		...
		g.board[6][3] = 'B';
		g.board[6][2] = 'R';
		assertEquals(3, p.MakeSelection(g));
	}
